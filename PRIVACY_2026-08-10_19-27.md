...
To sell licenses and let paying customers unlock the full app, we run a small Cloudflare Worker that tracks *instances*, not *businesses*. When you activate (PIN 789) or log in, your device sends:
...
- Activation status (active / observed / limited / blocked)
